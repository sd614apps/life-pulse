  ...
  const { data: authData, isFetched } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        console.error('[PageNotFound.getUser]', err);
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    This route is not registered in your application router. Check your route configuration or implement the component.
                  </p>
                </div>
              </div>
            </div>
